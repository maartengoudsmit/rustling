...
updated: '2026-02-26T13:46:05.110Z'
---
...
We can now easily use our filter {%raw%}`{{ published | relative_date }}`{%endraw%} to get:

```htmlbars
<span class="relative-date" data-date="2026-02-23T16:16:35.098Z">
3 hours ago
</span>
```
